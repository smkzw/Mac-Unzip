...
- Write exactly one output file: `runs/conference/zip_provider_vertical_slice/general_chair_glm.md`. The bounded runner persists your final response there; do not create sibling output files.

Read these files only:
- `AGENTS.md`
- `context/zip_provider_vertical_slice_conference_context.md`
- `plans/codex_main_venue_zip_provider_vertical_slice.md`
- `runs/conference/zip_provider_vertical_slice/general_aishuo_minimax.md`
- `runs/conference/zip_provider_vertical_slice/general_buddy_deepseek.md`
- `runs/conference/zip_provider_vertical_slice/general_opencode_mimo.md`

Objective:
Validate the real ZIP provider vertical slice: pinned minizip bridge, safe UTF-8 list/read/materialization, Windows-native ZIP creation, Chinese native app binding, security boundaries, and honest acceptance gates
...
Output schema:
1. `# Hermes Sub-Venue Review: zip_provider_vertical_slice - general_chair_glm`
2. `## Inputs Reviewed`
