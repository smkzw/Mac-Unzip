...
- Write exactly one output file: `runs/conference/windows_zip_creation_vertical_slice/general_opencode_mimo.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: windows_zip_creation_vertical_slice - general_opencode_mimo`
2. `## Boundary Check`
