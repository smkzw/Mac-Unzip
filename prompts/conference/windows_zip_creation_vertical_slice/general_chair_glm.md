...
- Write exactly one output file: `runs/conference/windows_zip_creation_vertical_slice/general_chair_glm.md`. The bounded runner persists your final response there; do not create sibling output files.

Read these files only:
- `context/windows_zip_creation_vertical_slice_conference_context.md`
- `plans/codex_main_venue_windows_zip_creation_vertical_slice.md`
- `runs/conference/windows_zip_creation_vertical_slice/general_aishuo_minimax.md`
- `runs/conference/windows_zip_creation_vertical_slice/general_buddy_deepseek.md`
- `runs/conference/windows_zip_creation_vertical_slice/general_opencode_mimo.md`

Objective:
设计并审查 Windows 11 原生兼容 ZIP 创建的端到端垂直切片：原生中文创建面板、输入与保存选择、全树兼容预检、流式创建、进度取消、同目录事务发布、创建后重新打开并核对清单/大小/SHA-256、失败清理和真实 E2E
...
Output schema:
1. `# Hermes Sub-Venue Review: windows_zip_creation_vertical_slice - general_chair_glm`
2. `## Inputs Reviewed`
