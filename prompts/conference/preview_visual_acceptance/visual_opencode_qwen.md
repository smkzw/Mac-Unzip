...
- Write exactly one output file: `runs/conference/preview_visual_acceptance/visual_opencode_qwen.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: preview_visual_acceptance - visual_opencode_qwen`
2. `## Boundary Check`
