...
- Write exactly one output file: `runs/conference/preview_visual_acceptance/visual_buddy_kimi.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: preview_visual_acceptance - visual_buddy_kimi`
2. `## Boundary Check`
