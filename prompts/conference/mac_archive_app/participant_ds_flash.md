...
- Write exactly one output file: `runs/conference/mac_archive_app/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: mac_archive_app - participant_ds_flash`
2. `## Boundary Check`
