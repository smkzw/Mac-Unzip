...
- Write exactly one output file: `runs/conference/mac_archive_app/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: mac_archive_app - participant_qwen_plus`
2. `## Boundary Check`
