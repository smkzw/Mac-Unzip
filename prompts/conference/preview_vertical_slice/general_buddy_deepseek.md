...
- Write exactly one output file: `runs/conference/preview_vertical_slice/general_buddy_deepseek.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: preview_vertical_slice - general_buddy_deepseek`
2. `## Boundary Check`
