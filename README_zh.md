...
![欢迎页](ArchiveWorkbench/Assets/screenshots/app_welcome.png)

### 🌙 压缩包浏览（深色模式）

媒体预览、文件详情、快捷操作——一屏搞定。

![压缩包浏览 - 深色模式](ArchiveWorkbench/Assets/screenshots/app_media_dark.png)

### ☀️ 压缩包浏览（浅色模式）

![压缩包浏览 - 浅色模式](ArchiveWorkbench/Assets/screenshots/app_media_light.png)
